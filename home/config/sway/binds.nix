...
let
  ...
  # TUIs
  file       = "sway-scratchpad -t -acc -- foot -T yazi -a yazi yazi";
  music      = "sway-scratchpad -t -acc -- foot -T cmus -a cmus cmus";
  smusic     = "sway-scratchpad -t -acc -- foot -T subtui -a subtui subtui";
  rss        = "sway-scratchpad -t -acc -- foot -T newsboat -a newsboat newsboat";
  anime      = "sway-scratchpad -t -acc -- foot -T ani-cli -a ani-cli ani-cli";
  youtube    = "sway-scratchpad -t -acc -- foot -T youtube-tui -a youtube-tui youtube-tui";
  audiomixer = "sway-scratchpad -t -acc -- foot -T pulsemixer -a pulsemixer pulsemixer";
  monitor    = "sway-scratchpad -t -acc -- foot -T btop -a btop btop";
  wifi       = "sway-scratchpad -t -acc -- foot -T impala -a impala impala";
  bluetooth  = "sway-scratchpad -t -acc -- foot -T bluetui -a bluetui bluetui";
  clipboard  = "sway-scratchpad -t -acc -- foot -T clipse -a clipse clipse";
